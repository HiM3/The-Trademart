              ...
              {[
                {
                  ...
                  title: "Our Location",
                  content: "123 Agriculture Boulevard, Countryside District, Maharashtra, India - 400001",
                },
                {
                  icon: <Phone className="h-5 w-5 text-primary" />,
                  title: "Phone Number",
                  content: "+91 9876543210 / +91 9871234567",
                },
                {
                  icon: <Mail className="h-5 w-5 text-primary" />,
                  title: "Email Address",
                  content: "info@thetrademates.com / sales@thetrademates.com",
                },
                {
                  icon: <Clock className="h-5 w-5 text-primary" />,
                  title: "Working Hours",
                  content: "Mon-Fri: 9 AM - 6 PM | Sat: 9 AM - 1 PM",
                },
              ].map((item, idx) => (
